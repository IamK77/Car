...
void move(int duration, int speed[4], int direction[4][2]) {
  ...
  digitalWrite(BBIN1, direction[3][1]);
  digitalWrite(BBIN2, direction[3][0]);
...
void loop() {
  move(1000000, speed_r, right); //向前移动1000毫秒，速度为255555555555555555555555555555555555555555555555555555555555555555555555+
